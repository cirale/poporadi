...
./rec_radiko.sh QRR 1 . $programName
python3 ./setTag.py $programName $artist
filename="ご注文はラジオですか？？～WELCOME【う・さ！】～_${today}.mp3"
directoryId=`gdrive-linux-x64 list --query "mimeType='application/vnd.google-apps.folder' and name='ご注文はラジオですか？？～WELCOME【う・さ！】～'" | awk '!/Id/{print $1}'`
